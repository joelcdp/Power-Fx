...
{
    //  Maximize(source, "name", ...) : b
    internal sealed class MaximizeFunction : FunctionWithTableInput
    {
        ...
        public MaximizeFunction()
            : base("Maximize", TexlStrings.AboutAddConstraint, FunctionCategories.Logical, DType.Boolean, 0x6, 3, int.MaxValue, DType.EmptyTable, DType.String)
        {
