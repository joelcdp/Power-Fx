...
{
    //  Minimize(source, "name", ...) : b
    internal sealed class MinimizeFunction : FunctionWithTableInput
    {
        ...
        public MinimizeFunction()
            : base("Minimize", TexlStrings.AboutAddConstraint, FunctionCategories.Logical, DType.Boolean, 0x6, 3, int.MaxValue, DType.EmptyTable, DType.String)
        {
